...
function shuffleCardImageClasses() {
  ...
  const classesArray = ["image-1","image-1", "image-2","image-2", "image-3", "image-3", "image-4","image-4", "image-5","image-5", "image-6","image-6"];


let shuffledArray = _.shuffle(classesArray);

  /* Step 2 Shuffle the array using underscore.js */
